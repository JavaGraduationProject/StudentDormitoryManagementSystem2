...
<div class="data_list">
	...
	<form action="record?action=save" method="post"
			...
			<table align="center">
				<tr>
					...
					<td><input type="text" id="studentNumber" name="studentNumber"
						value="${record.studentNumber==null?studentNumber:record.studentNumber }"
						style="margin-top: 5px; height: 30px;"
						${studentNumber!=null?'readonly':'' } /></td>
				</tr>
				<tr>
					<td><font color="red">*</font>日期：</td>
					<td><input type="text" id="date" name="date"
						value="${record.date==null?date:record.date }"
				...
				<tr>
					...
					<td><input type="text" id="detail" name="detail"
						value="${record.detail }" style="margin-top: 5px; height: 30px;" /></td>
				</tr>
			</table>
			<div align="center">
				<input type="submit" class="btn btn-primary" value="保存" /> &nbsp;
				<button class="btn btn-primary" type="button"
					onclick="javascript:window.location='record'">返回</button>
			</div>
			<div align="center">
